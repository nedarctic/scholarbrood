...
import { FetchDataSteps } from "@/app/(app)/components/tutorial/fetch-data-steps";
...
export default async function DashboardPage() {
  ...
  return (
    <main
      className={`${oswald.className} min-h-screen overflow-x-hidden font-sans bg-white dark:bg-[#1C1C30] text-gray-900 dark:text-gray-100 transition-colors duration-500`}
    >
      {/* Dashboard Hero */}
      <section className="relative pt-10 pb-[55px] px-5 sm:px-8">
        <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-green-500/10 to-emerald-600/5 border-2 border-green-500/20 rounded-3xl p-8 shadow-xl">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold">{payPalPlanName} Plan Active</h3>
                      <p className="text-gray-700 dark:text-gray-300">
          ...
          <div>
            ...
            <div className="flex-col lg:flex space-y-6">
