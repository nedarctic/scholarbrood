...
export default function SideNav() {
  ...
  return (
    <div className={`${oswald.className} fixed left-0 top-0 h-screen w-64 z-30 flex flex-col px-3 py-6 md:px-4 bg-white dark:bg-[#1C1C30] border-r border-gray-200 dark:border-gray-700 shadow-xl transition-all duration-300`}>
